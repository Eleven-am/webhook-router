...
// BasicPipelineEngine implements the PipelineEngine interface
...
func NewBasicPipelineEngine() *BasicPipelineEngine {
	return &BasicPipelineEngine{
		...
		metrics: &PipelineMetrics{
			PipelineMetrics: make(map[string]PipelineMetric),
...
func (e *BasicPipelineEngine) RegisterPipeline(pipeline Pipeline) error {
	...
	e.metrics.PipelineMetrics[pipeline.ID()] = PipelineMetric{
		LastExecution: time.Now(),
	}
...
func (e *BasicPipelineEngine) ExecutePipeline(ctx context.Context, pipelineID string, data *PipelineData) (*PipelineResult, error) {
...
func (e *BasicPipelineEngine) RegisterStageFactory(stageType string, factory StageFactory) error {
	if factory == nil {
...
func (e *BasicPipelineEngine) GetMetrics() (*PipelineMetrics, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
...
func (p *BasicPipeline) Execute(ctx context.Context, data *PipelineData) (*PipelineResult, error) {
	start := time.Now()
...
func (p *BasicPipeline) retryStage(ctx context.Context, stage Stage, data *PipelineData, retryConfig RetryConfig) error {
...
func (e *BasicPipelineEngine) CreatePipelineFromConfig(config *PipelineConfig) (Pipeline, error) {
