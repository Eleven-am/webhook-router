-- Execution logs table for comprehensive trigger and pipeline_old tracking
...
CREATE TABLE IF NOT EXISTS execution_logs (
    ...
    trigger_config TEXT DEFAULT '{}', -- JSON config specific to trigger type
    ...
    input_headers TEXT DEFAULT '{}', -- JSON headers or metadata
    input_body TEXT, -- Request body or trigger payload
    
    -- Pipeline processing
    pipeline_id TEXT,
    pipeline_stages TEXT DEFAULT '[]', -- JSON array of stages executed
    transformation_data TEXT DEFAULT '{}', -- JSON of transformation details
